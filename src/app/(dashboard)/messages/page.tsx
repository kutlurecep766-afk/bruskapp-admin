...
const themeWallpaper: Record<string, string> = {
  whatsapp: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%2300a884' fill-opacity='0.08'%3E%3Cpath d='M30 2l4 12h12l-10 8 4 12-10-6-10 6 4-12-10-8h12z'/%3E%3C/g%3E%3C/svg%3E"), linear-gradient(45deg, #0b141a 0%, #0d1f1a 50%, #0b141a 100%)`,
  instagram: `url("data:image/svg+xml,%3Csvg width='80' height='80' viewBox='0 0 80 80' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23e1306c' fill-opacity='0.1'%3E%3Ccircle cx='40' cy='40' r='4'/%3E%3Ccircle cx='12' cy='12' r='3'/%3E%3Ccircle cx='68' cy='12' r='3'/%3E%3Ccircle cx='12' cy='68' r='3'/%3E%3Ccircle cx='68' cy='68' r='3'/%3E%3C/g%3E%3C/svg%3E"), linear-gradient(135deg, #1a0d14 0%, #1a0d1a 30%, #0d0a14 70%, #1a0d14 100%)`,
  telegram: `url("data:image/svg+xml,%3Csvg width='50' height='50' viewBox='0 0 50 50' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%232aabee' fill-opacity='0.09'%3E%3Cpath d='M25 5l3 10h10l-8 6 3 10-8-5-8 5 3-10-8-6h10z'/%3E%3C/g%3E%3C/svg%3E"), linear-gradient(180deg, #0b141a 0%, #0d1420 50%, #0b141a 100%)`,
  messenger: `url("data:image/svg+xml,%3Csvg width='70' height='70' viewBox='0 0 70 70' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%230066ff' fill-opacity='0.09'%3E%3Crect x='10' y='10' width='12' height='12' rx='3'/%3E%3Crect x='48' y='10' width='12' height='12' rx='3'/%3E%3Crect x='10' y='48' width='12' height='12' rx='3'/%3E%3Crect x='48' y='48' width='12' height='12' rx='3'/%3E%3Crect x='29' y='29' width='12' height='12' rx='3'/%3E%3C/g%3E%3C/svg%3E"), linear-gradient(160deg, #080c18 0%, #0a1020 40%, #080c18 100%)`,
  trendyol: `url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%23f27a1a' fill-opacity='0.1'%3E%3Cpath d='M20 2l8 18-8 18-8-18z'/%3E%3C/g%3E%3C/svg%3E"), linear-gradient(135deg, #0d0a08 0%, #140e08 40%, #0d0a08 100%)`,
  hepsiburada: `url("data:image/svg+xml,%3Csvg width='48' height='48' viewBox='0 0 48 48' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='%238b5cf6' fill-opacity='0.09'%3E%3Cpath d='M6 6h12v12H6zM30 6h12v12H30zM6 30h12v12H6zM30 30h12v12H30z'/%3E%3C/g%3E%3C/svg%3E"), linear-gradient(45deg, #0a0a10 0%, #100a14 50%, #0a0a10 100%)`,
}
      ...
      <div className={'flex-1 flex flex-col overflow-hidden relative ' + (mobileView === 'list' ? 'hidden md:flex' : 'flex')} style={{ backgroundColor: selectedConv ? (themeBg[messages[0]?.platform] || '#0a0e14') : '#0a0e14' }}>
        {selectedConv ? (
          <>
            ...
            <div className="flex-1 overflow-y-auto p-3 md:p-4 space-y-0.5 scrollbar-thin scrollbar-thumb-white/[0.06] scrollbar-track-transparent chat-area relative" style={{ background: themeWallpaper[messages[0]?.platform] || themeChatBg[messages[0]?.platform] || '#0a0e14' }}>
              {msgLoading ? (
