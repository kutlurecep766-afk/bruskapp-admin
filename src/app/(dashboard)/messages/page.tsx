...
const ps = (p: string) => {
  ...
  return PLATFORM_MAP[p] || { label: p, color: 'text-gray-400', bg: 'bg-gray-500/10', icon: null, dot: 'bg-gray-400' }
}

const displayName = (p: string, from: string, fromName?: string | null) => {
  const isWhatsapp = p === 'whatsapp' || p === 'zernio_whatsapp'
  if (isWhatsapp) return from || fromName || 'Bilinmeyen'
