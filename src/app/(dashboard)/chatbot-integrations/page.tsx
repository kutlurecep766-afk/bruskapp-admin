...
const PLATFORM_SVGS: Record<string, string> = {
  ...
  trendyol: `<svg viewBox="0 0 24 24" fill="none"><rect x="3" y="5" width="18" height="14" rx="3" stroke="currentColor" stroke-width="1.5"/><path d="M7 9h10M7 13h6M7 17h2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><circle cx="17" cy="15" r="3" fill="currentColor" opacity="0.3"/><text x="17" y="17" text-anchor="middle" font-size="6" font-weight="bold" fill="white">T</text></svg>`,
  hepsiburada: `<svg viewBox="0 0 24 24" fill="none"><rect x="2" y="3" width="20" height="18" rx="3" stroke="currentColor" stroke-width="1.5"/><path d="M8 7h8v10H8V7z" stroke="currentColor" stroke-width="1.5"/><path d="M10 9h4v6h-4V9z" fill="currentColor" opacity="0.4"/><text x="12" y="16" text-anchor="middle" font-size="5" font-weight="bold" fill="white">H</text></svg>`,
  n11: `<svg viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="1.5"/><text x="12" y="15" text-anchor="middle" font-size="8" font-weight="bold" fill="currentColor">n</text><text x="16" y="15" text-anchor="middle" font-size="6" font-weight="bold" fill="currentColor" opacity="0.5">11</text></svg>`,
...
export default function ChatbotIntegrationsPage() {
  ...
  const handleConnect = async (platform: string, type: string) => {
    ...
    if (type === 'webchat') {
      ...
      setWebchatConnected(true)
      showToast('success', 'Web Chat aktifleştirildi!')
      return
    }
