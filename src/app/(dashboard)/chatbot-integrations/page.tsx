...
const PLATFORM_SVGS: Record<string, string> = {
  ...
  trendyol: `<svg viewBox="0 0 48 48"><rect width="48" height="48" rx="12" fill="#F27A00"/><text x="24" y="33" font-family="Arial,Helvetica,sans-serif" font-weight="800" font-size="32" text-anchor="middle" fill="white">t</text></svg>`,
  hepsiburada: `<svg viewBox="0 0 48 48"><rect width="48" height="48" rx="12" fill="#572B85"/><path d="M12 14h24v20H12V14z" fill="white" rx="2"/><text x="16" y="28" font-family="Arial,Helvetica,sans-serif" font-weight="800" font-size="13" fill="#572B85">HB</text></svg>`,
  n11: `<svg viewBox="0 0 48 48"><circle cx="24" cy="24" r="22" fill="#D7003A"/><text x="15" y="32" font-family="Arial,Helvetica,sans-serif" font-weight="800" font-size="18" fill="white">n</text><text x="24" y="32" font-family="Arial,Helvetica,sans-serif" font-weight="700" font-size="14" fill="white">11</text></svg>`,
